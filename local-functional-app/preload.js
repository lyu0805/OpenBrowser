...
contextBridge.exposeInMainWorld('ops', Object.freeze({
  ...
  rpaTemplateSyncAds: (payload) => ipcRenderer.invoke('automation:rpa-template-sync-ads', payload || {}),
  rpaTemplateConfig: (payload) => ipcRenderer.invoke('automation:rpa-template-config', payload || null),
  rpaTemplateImportAds: (payload) => ipcRenderer.invoke('automation:rpa-template-import-ads', payload || {}),
